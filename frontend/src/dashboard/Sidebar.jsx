...
function Sidebar({ setComponent }) {
  ...
  return (
    <>
      <div
        className="md:hidden fixed top-4 left-4 z-500"
        onClick={() => setShow(!show)}
      >
        <CiMenuBurger className="text-2xl" />
      </div>
      <div
        className={`z-50 w-64 h-full shadow-lg fixed top-0 left-0 bg-gray-50 transition-transform duration-300 transform md:translate-x-0 ${
